...
playlist_id = Frodo.config.education_playlist_id

# Link to appropriate view file
html_file = 'education_videos.html'
...
def read_last_shuffle_list():
    try:
        ...
        with open('../education_shuffle_list.txt', 'r') as file:
...
def get_education_videos(request):
    ...
    if last_shuffle_date == current_date:
        ...
        with open('../education_shuffle_list.txt', 'w') as file:
