...
# Line 46: with open('EDIT_shuffle_list.txt', 'r') as file:
...
playlist_id = Frodo.config.doco_playlist_id

# Link to appropriate view file
html_file = 'doco_videos.html'
...
def read_last_shuffle_list():
    try:
        ...
        with open("doco_shuffle_list.txt", "r") as file:
...
def get_doco_videos(request):
    ...
    if last_shuffle_date == current_date:
        ...
        with open("doco_shuffle_list.txt", "w") as file:
