...
playlist_id = Frodo.config.sport_playlist_id

# Link to appropriate view file
html_file = 'sport_videos.html'
...
def read_last_shuffle_list():
    try:
        ...
        with open("sport_shuffle_list.txt", "r") as file:
...
def get_sport_videos(request):
    ...
    if last_shuffle_date == current_date:
        ...
        with open("sport_shuffle_list.txt", "w") as file:
