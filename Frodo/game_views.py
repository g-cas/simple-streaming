...
playlist_id = Frodo.config.game_playlist_id

# Link to appropriate view file
html_file = 'game_videos.html'
...
def read_last_shuffle_list():
    try:
        ...
        with open('../game_shuffle_list.txt', 'r') as file:
...
def get_game_videos(request):  # change for each view file
    ...
    if last_shuffle_date == current_date:
        ...
        with open('../game_shuffle_list.txt', 'w') as file:
