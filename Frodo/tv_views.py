...
playlist_id = Frodo.config.tv_playlist_id

# Link to appropriate view file
html_file = 'tv_videos.html'
...
def read_last_shuffle_list():
    try:
        ...
        with open("tv_shuffle_list.txt", "r") as file:
...
def get_tv_videos(request):
    ...
    if last_shuffle_date == current_date:
        ...
        with open("tv_shuffle_list.txt", "w") as file:
